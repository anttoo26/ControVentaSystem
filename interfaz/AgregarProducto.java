...
public class AgregarProducto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty() || jTextField6.getText().isEmpty()){
            ...
            try {
                res = Manejo.Conexion.Consulta("Select COUNT(Id_Producto)from Producto where Id_Producto='" + jTextField1.getText() + "'");
                try{
                    while(res.next()){
                        cont = res.getInt(1); 
                    }
                ...
                if(cont >= 1){
                    ...
                    Procedimientos.EntradaProducto(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), Integer.parseInt(jTextField4.getText()),

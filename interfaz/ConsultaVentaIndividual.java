 ...
 * @author Cesar
 */
public class ConsultaVentaIndividual extends javax.swing.JFrame {

    static ResultSet res;
    /**
     * Creates new form ConsultaVentaIndividual
     */
    public ConsultaVentaIndividual() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Individual Venta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaVentaIndividual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaVentaIndividual().setVisible(true);
            }
        });
    }
